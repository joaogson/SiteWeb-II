...
<div class="box-content">
    <h2><i class="fas fa-database"></i> Barbeiros cadastrados</h2>
    ...
    <div class="wraper-table">
        <table>
            ...
            <tr>
                ...
                <td><img style="width:60px; height:60px;" src="<?php echo INCLUDE_PATH_PAINEL;?>uploads/<?php echo $value['capa'];?>"></td>
                <td><a class="edit" href="<?php echo INCLUDE_PATH_PAINEL ?>editar-noticias?id=<?php echo $value['id']; ?>"><i class="fas fa-edit"></i></a></td>
                <td><a actionBtn="delete" class="delete" href="<?php echo INCLUDE_PATH_PAINEL ?>listar-noticias?excluir=<?php echo $value['id']; ?>"><i class="fas fa-trash"></i></a></td>
                <td><a class="order-down" href="<?php echo INCLUDE_PATH_PAINEL; ?>listar-noticias?order=up&id=<?php echo $value['id'];?>">
                    <i class="fa-solid fa-angle-down"></i></a></td>
                <td><a class="order-up" href="<?php echo INCLUDE_PATH_PAINEL; ?>listar-noticias?order=down&id=<?php echo $value['id'];?>">
