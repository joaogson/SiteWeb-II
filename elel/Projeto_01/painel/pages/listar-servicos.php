...
if(isset($_GET['excluir'])){
    ...
    Painel::ordemItem('tb_admin.servicos', $_GET['order'], $_GET['id']);
}
    ...
    <div class="wraper-table">
        <table>
            ...
            <tr>
                ...
                <td><a class="edit" href="<?php echo INCLUDE_PATH_PAINEL ?>editar-servico?id=<?php 
                ...
                <td><a class="order-down" href="<?php echo INCLUDE_PATH_PAINEL;
                                                ?>listar-servicos?order=up&id=<?php echo $value['id'];?>">
                                                <i class="fa-solid fa-angle-down"></i></a></td>
                <td><a class="order-up" href="<?php echo INCLUDE_PATH_PAINEL;
                                                ?>listar-servicos?order=down&id=<?php echo $value['id'];?>">
