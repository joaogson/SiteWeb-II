...
<div class="box-content">
	<h2><i class="fas fa-database">Categorias Cadastradas</i></h2>
	...
	<table>
		...
		<tr>
			...
			<td><a actionBtn="delete" class="delete" href="<?php echo INCLUDE_PATH_PAINEL ?>listar-categorias?excluir=<?php 
												echo $value['id'];?>"><i class="fas fa-trash"></i></a></td>
			<td><a class="order-down" href="<?php echo INCLUDE_PATH_PAINEL ?>listar-categorias?order=up&id=<?php 
												echo $value['id'];?>"><i class="fa-solid fa-angle-down"></i></a></td>
			<td><a class="order-up" href="<?php echo INCLUDE_PATH_PAINEL ?>listar-categorias?order=down&id=<?php 
